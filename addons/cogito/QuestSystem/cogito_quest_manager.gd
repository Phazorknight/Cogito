...
const COGITO_QUEST_FAILED = preload("../Assets/Audio/Phazorknight/Cogito_QuestFailed.wav")
const COGITO_QUEST_START = preload("..//Assets/Audio/Phazorknight/Cogito_QuestStart.wav")
